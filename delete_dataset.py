...
def main(id, confirm, qdict):
    ...
    if confirm == 0:
        ...
        if id == 0:
            ...
            print '<br>'
            print '<form action="/cgi-bin/db/delete_dataset.py?id=%d&confirm=1&%s" method="post">' % \
                (id, dbargs.convert_args(qdict))
            print '<input type="submit" value="Delete">'
            print '<input type="submit" value="Cancel" formaction="/cgi-bin/db/edit_datasets.py?id=%d&%s">' % \
