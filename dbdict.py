...
databaseDict = {'projects': [('id', '', 'INT NOT NULL PRIMARY KEY AUTO_INCREMENT', 0, 'Project ID', 0),
                             ...
                             ('poms_campaign', '', 'VARCHAR(1000)', 0, 'POMS campaign', ''),
                             ('poms_login_setup', '', 'VARCHAR(1000)', 0, 'POMS login/setup', ''),
                             ('poms_job_type', '', 'VARCHAR(1000)', 0, 'POMS job type', ''),
                             ('poms_role', '', 'VARCHAR(100)', 0, 'POMS Role', 'production'),
                             ('physics_group', 'physicsgroup', 'VARCHAR(100)', 0, 'Physics Group', ''),
                             ('status', '', 'VARCHAR(100)', 0, 'Status', ''),
                             ('campaign', '', 'VARCHAR(100)', 0, 'Campaign', ''),
                             ...
                             ('release_qual', 'larsoft/qual', 'VARCHAR(1000)', 0, 'Release qualifier', 'e17:prof'),
                             ...
                             ('run_type', 'runtype', 'VARCHAR(1000)', 0, 'Run type', 'physics'),
                ...
                'stages': [('id', '', 'INT NOT NULL PRIMARY KEY AUTO_INCREMENT', 0, 'Stage ID', 0),
                           ...
                           ('dirlevels', 'dirlevels', 'INT', 0, 'Intermediate directory levels', 1),
                           ('dirsize', 'dirsize', 'INT', 0, 'Intermediate directory size', 100),
                           ...
                           ('prestart', 'prestart', 'INT', 0, 'Prestart sam project flag', 1),
                           ('activebase', 'activebase', 'VARCHAR(1000)', 0, 'Active project base', ''),
                           ('dropboxwait', 'dropboxwait', 'DOUBLE', 0, 'Dropbox waiting period', 0.),
                           ('prestagefraction', 'prestagefraction', 'DOUBLE', 0, 'Prestage fraction', 1.),
                           ('maxfluxfilemb', 'maxfluxfilemb', 'INT', 0, 'Maximum flux file MB', 0),
                           ('num_jobs', 'numjobs', 'INT', 0, 'Number of jobs', 1),
                           ('num_events', 'numevents', 'INT', 0, 'Number of events', 0),
                           ('max_files_per_job', 'maxfilesperjob', 'INT', 0, 'Maximum files per job', 1),
